...
const JobDetail = () => {
    ...
    <section className='flex justify-center items-center container w-full'>

        <div className="min-w-298 relative">
            ...
            <div className='flex flex-col justify-center items-center m-auto  responsive'> 
